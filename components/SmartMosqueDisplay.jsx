    ...
    return(
        <div className="relative h-screen w-screen overflow-hidden bg-background">
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                {displayMode === 'NORMAL' && (
                    <>
                        <div className="flex-shrink-0 h-[40%] flex items-center justify-center animate-fade-in">
                ...
                {displayMode === 'IQOMAH' && (
                    <div className="animate-fade-in flex flex-col items-center justify-center text-center w-full bg-black/80 backdrop-blur-xl p-10 md:p-20 rounded-3xl border-2 border-yellow-500/50 shadow-[0_0_100px_rgba(234,179,8,0.2)]">
